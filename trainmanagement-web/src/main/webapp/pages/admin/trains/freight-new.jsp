...
<head>
    ...
    <c:url var="style" value="/resources/css/admin/trains/freight-new.css"/>
        ...
        <form id="newTrain">
            ...
            <table class='table form-text table-edit'>
                ...
                <tr class="warning">
                    ...
                    <td><input type="text" class="input-width-new" id="date" value=""/>
                ...
                <tr class="warning">
                    <td><label>Enter volume_limit</label></td>
                    <td><input class='input-width-new' type="text" id="volumeLimit"/></td>
                </tr>
                <tr class="warning">
                    <td><label>Enter weight_limit</label></td>
                    <td><input class='input-width-new' type="text" id="weightLimit"/></td>
                </tr>
                <%--<tr class="warning">--%>
                    <%--<td><label>Enter volume</label></td>--%>
                    <%--<td><input class='input-width-new' type="text" id="volume" value="0"disabled/></td>--%>
                <%--</tr>--%>
                <%--<tr class="warning">--%>
                    <%--<td><label>Enter weight</label></td>--%>
                    <%--<td><input class='input-width-new' type="text" id="weight" value="0"disabled/></td>--%>
                <%--</tr>--%>
...
<script>
    ...
    $('#newTrain').submit(function (event) {
        ...
        var json = {
            ...
            'arrival': $('#arrival').val(),
            'volumeLimit': $('#volumeLimit').val(),
            'weightLimit': $('#weightLimit').val(),
            'volume': 0,
            'weight': 0
        };
